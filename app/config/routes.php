...
return [
	...
	'main/index/{page:\w+}' => ['controller' => 'main',	'action' => 'index'],
	'about' => ['controller' => 'main',	'action' => 'about'],
	'contact' => ['controller' => 'main', 'action' => 'contact'],
	'post/{id:\w+}' => ['controller' => 'main',	'action' => 'post'],
	/*
	 *      AdminController
	 */
	...
	'admin/edit/{id:\w+}' => ['controller' => 'admin', 'action' => 'edit'],
	'admin/delete/{id:\w+}' => ['controller' => 'admin', 'action' => 'delete'],
	'admin/posts/{page:\w+}' => ['controller' => 'admin', 'action' => 'posts'],
